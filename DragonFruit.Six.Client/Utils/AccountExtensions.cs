...
namespace DragonFruit.Six.Client.Utils
{
    ...
    {
        public static string GetName(this IDragon6User dragon6User) => string.IsNullOrEmpty(dragon6User.Title) ? GetName(dragon6User.AccountRole) : dragon6User.Title;
        public static string GetIcon(this IDragon6User dragon6User) => string.IsNullOrEmpty(dragon6User.TitleIcon) ? GetIcon(dragon6User.AccountRole) : dragon6User.TitleIcon;
        public static string GetColor(this IDragon6User dragon6User) => string.IsNullOrEmpty(dragon6User.TitleColour) ? GetColor(dragon6User.AccountRole) : dragon6User.TitleColour;
