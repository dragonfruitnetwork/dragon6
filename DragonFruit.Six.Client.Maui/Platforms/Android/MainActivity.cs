...
namespace DragonFruit.Six.Client.Maui
{
    ...
    [IntentFilter(new[] { Intent.ActionView }, Categories = new[] { Intent.CategoryDefault, Intent.CategoryBrowsable }, DataSchemes = new[] { "http", "https" }, DataHost = "dragon6.dragonfruit.network", DataPathPrefix = "/stats/")]
